...
Namespace ssh
	...
	Public Class todos_registros
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.todos_registros_Load)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.todos_alumnos.rdlc"
			Me.ReportViewer1.Location = New Point(0, 0)
			Me.ReportViewer1.Name = "ReportViewer1"
			Me.ReportViewer1.Size = New System.Drawing.Size(1034, 528)
			Me.ReportViewer1.TabIndex = 0
			Me.matricula2TableAdapter.ClearBeforeFill = True
			MyBase.AutoScaleDimensions = New SizeF(6!, 13!)
			MyBase.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font
			MyBase.ClientSize = New System.Drawing.Size(1034, 528)
			MyBase.Controls.Add(Me.ReportViewer1)
			MyBase.Name = "todos_registros"
			Me.Text = "Todos los registros"
			MyBase.TopMost = True
		...
		Private Sub todos_registros_Load(ByVal sender As Object, ByVal e As EventArgs)
			...
			Dim str As String = "select * from matricula2 order by grado "
			Try
