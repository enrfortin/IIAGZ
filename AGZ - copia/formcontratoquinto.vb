...
Namespace ssh
	<DesignerGenerated>
	Public Class formcontratoquinto
		Inherits Form
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratoquinto_Load)
		...
		Private Sub formcontratoquinto_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.quinto.rdlc"
			...
			MyBase.Name = "formcontratoquinto"
