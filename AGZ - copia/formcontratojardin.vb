...
Namespace ssh
	<DesignerGenerated>
	Public Class formcontratojardin
		Inherits Form
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratojardin_Load)
		...
		Private Sub formcontratojardin_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.jardin.rdlc"
			...
			MyBase.Name = "formcontratojardin"
