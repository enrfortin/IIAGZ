...
Namespace ssh
	<DesignerGenerated>
	Public Class formcontratoprimero
		Inherits Form
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratoprimero_Load)
		...
		Private Sub formcontratoprimero_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.primero.rdlc"
			...
			MyBase.Name = "formcontratoprimero"
