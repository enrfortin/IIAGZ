...
Namespace ssh
	...
	Public Class formcontratoCYF
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratoCYF_Load)
		...
		Private Sub formcontratoCYF_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.CYF.rdlc"
