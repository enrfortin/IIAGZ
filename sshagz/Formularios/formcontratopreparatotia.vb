...
Namespace ssh
	<DesignerGenerated>
	Public Class formcontratopreparatotia
		Inherits Form
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratopreparatotia_Load)
		...
		Private Sub formcontratopreparatotia_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.preparatoria.rdlc"
			...
			MyBase.Name = "formcontratopreparatotia"
