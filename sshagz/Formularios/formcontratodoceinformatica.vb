...
Namespace ssh
	<DesignerGenerated>
	Public Class formcontratodoceinformatica
		Inherits Form
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratodoce_Load)
		...
		Private Sub formcontratodoce_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.doceavo.rdlc"
			...
			MyBase.Name = "formcontratodoceinformatica"
