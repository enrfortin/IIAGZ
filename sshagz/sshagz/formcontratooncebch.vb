...
Namespace ssh
	<DesignerGenerated>
	Public Class formcontratooncebch
		Inherits Form
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratooncebch_Load)
		...
		Private Sub formcontratooncebch_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.oncebch.rdlc"
			...
			MyBase.Name = "formcontratooncebch"
