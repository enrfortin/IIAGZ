...
Namespace ssh
	<DesignerGenerated>
	Public Class formcontratocuarto
		Inherits Form
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratocuarto_Load)
		...
		Private Sub formcontratocuarto_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.cuarto.rdlc"
			...
			MyBase.Name = "formcontratocuarto"
