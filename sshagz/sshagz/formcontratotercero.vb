...
Namespace ssh
	<DesignerGenerated>
	Public Class formcontratotercero
		Inherits Form
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratotercero_Load)
		...
		Private Sub formcontratotercero_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.tercero.rdlc"
			...
			MyBase.Name = "formcontratotercero"
