...
Namespace ssh
	<DesignerGenerated>
	Public Class formcontratonoveno
		Inherits Form
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratonoveno_Load)
		...
		Private Sub formcontratonoveno_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.noveno.rdlc"
			...
			MyBase.Name = "formcontratonoveno"
