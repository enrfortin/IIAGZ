...
Namespace ssh.chrilyhd_matriculaagzDataSetTableAdapters
	...
	Public Class matriculaTableAdapter
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		<HelpKeyword("vs.data.TableAdapter")>
		Public Overridable Function Fill(ByVal dataTable As chrilyhd_matriculaagzDataSet.matriculaDataTable) As Integer
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		<HelpKeyword("vs.data.TableAdapter")>
		Public Overridable Function GetData() As chrilyhd_matriculaagzDataSet.matriculaDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim _matriculaDataTable As chrilyhd_matriculaagzDataSet.matriculaDataTable = New chrilyhd_matriculaagzDataSet.matriculaDataTable()
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		<HelpKeyword("vs.data.TableAdapter")>
		Public Overridable Function Update(ByVal dataTable As chrilyhd_matriculaagzDataSet.matriculaDataTable) As Integer
