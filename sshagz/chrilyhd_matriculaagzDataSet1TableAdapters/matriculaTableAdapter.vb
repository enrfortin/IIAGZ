...
Namespace ssh.chrilyhd_matriculaagzDataSet1TableAdapters
	...
	<ToolboxItem(True)>
	Public Class matriculaTableAdapter
		Inherits Component
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		<HelpKeyword("vs.data.TableAdapter")>
		Public Overridable Function Fill(ByVal dataTable As chrilyhd_matriculaagzDataSet1.matriculaDataTable) As Integer
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		<HelpKeyword("vs.data.TableAdapter")>
		Public Overridable Function GetData() As chrilyhd_matriculaagzDataSet1.matriculaDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim _matriculaDataTable As chrilyhd_matriculaagzDataSet1.matriculaDataTable = New chrilyhd_matriculaagzDataSet1.matriculaDataTable()
			Me.Adapter.Fill(_matriculaDataTable)
		...
		Private Sub InitAdapter()
			...
			{
				.Connection = Me.Connection,
				.CommandText = "INSERT INTO `matricula` (`nombre`, `identidad_alumno`, `idp`, `grado`, `profesion`, `padre`, `telefono`, `email`, `codigo`, `direccion`) VALUES (@p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8, @p9, @p10)",
				.CommandType = CommandType.Text
			}
			mySqlParameter = New MySql.Data.MySqlClient.MySqlParameter() With
			{
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT `id_matricula`, `nombre`, `identidad_alumno`, `idp`, `grado`, `profesion`, `padre`, `telefono`, `email`, `codigo`, `direccion` FROM `matricula`"
		...
		Private Sub InitConnection()
            ...
            {
                .ConnectionString = My.chrilyhd_matriculaagzConnectionString
            }
        End Sub
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		<HelpKeyword("vs.data.TableAdapter")>
		Public Overridable Function Update(ByVal dataTable As chrilyhd_matriculaagzDataSet1.matriculaDataTable) As Integer
