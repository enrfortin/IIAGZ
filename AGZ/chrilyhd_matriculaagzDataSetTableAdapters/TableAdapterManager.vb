...
Namespace ssh.chrilyhd_matriculaagzDataSetTableAdapters
	...
	Public Class TableAdapterManager
		...
		Private _matriculaTableAdapter As ssh.chrilyhd_matriculaagzDataSetTableAdapters.matriculaTableAdapter

		Private _matricula2TableAdapter As ssh.chrilyhd_matriculaagzDataSetTableAdapters.matricula2TableAdapter
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		Public Property matricula2TableAdapter As ssh.chrilyhd_matriculaagzDataSetTableAdapters.matricula2TableAdapter
			Get
				Return Me._matricula2TableAdapter
			End Get
			Set(ByVal value As ssh.chrilyhd_matriculaagzDataSetTableAdapters.matricula2TableAdapter)
		...
		<Editor("Microsoft.VSDesigner.DataSource.Design.TableAdapterManagerPropertyEditor, Microsoft.VSDesigner, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor")>
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		Public Property matriculaTableAdapter As ssh.chrilyhd_matriculaagzDataSetTableAdapters.matriculaTableAdapter
			Get
				Return Me._matriculaTableAdapter
			End Get
			Set(ByVal value As ssh.chrilyhd_matriculaagzDataSetTableAdapters.matriculaTableAdapter)
		...
		<DebuggerNonUserCode>
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		Public Overridable Function UpdateAll(ByVal dataSet As chrilyhd_matriculaagzDataSet) As Integer
			Dim num As Integer
		...
		<DebuggerNonUserCode>
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		Private Function UpdateDeletedRows(ByVal dataSet As chrilyhd_matriculaagzDataSet, ByVal allChangedRows As List(Of DataRow)) As Integer
			Dim num As Integer = 0
			If (Me._matricula2TableAdapter IsNot Nothing) Then
		...
		<DebuggerNonUserCode>
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		Private Function UpdateInsertedRows(ByVal dataSet As chrilyhd_matriculaagzDataSet, ByVal allAddedRows As List(Of DataRow)) As Integer
			Dim num As Integer = 0
			If (Me._matriculaTableAdapter IsNot Nothing) Then
		...
		<DebuggerNonUserCode>
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>
		Private Function UpdateUpdatedRows(ByVal dataSet As chrilyhd_matriculaagzDataSet, ByVal allChangedRows As List(Of DataRow), ByVal allAddedRows As List(Of DataRow)) As Integer
			Dim num As Integer = 0
			If (Me._matriculaTableAdapter IsNot Nothing) Then
