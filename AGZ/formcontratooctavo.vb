...
Namespace ssh
	<DesignerGenerated>
	Public Class formcontratooctavo
		Inherits Form
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratooctavo_Load)
		...
		Private Sub formcontratooctavo_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.octavo.rdlc"
			...
			MyBase.Name = "formcontratooctavo"
