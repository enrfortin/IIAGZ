...
Namespace ssh
	<DesignerGenerated>
	Public Class formcontratoonceinformatica
		Inherits Form
		...
		Public Sub New()
			MyBase.New()
			AddHandler MyBase.Load,  New EventHandler(AddressOf Me.formcontratoonceinformatica_Load)
		...
		Private Sub formcontratoonceinformatica_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub InitializeComponent()
			...
			Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ssh.onceinformatica.rdlc"
			...
			MyBase.Name = "formcontratoonceinformatica"
